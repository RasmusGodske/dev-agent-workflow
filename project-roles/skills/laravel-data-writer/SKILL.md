...
description: Skill for creating and editing Spatie Laravel Data classes following project conventions. Use when working with Data classes, DTOs, or data transfer objects. Enforces proper constructor-based properties, annotation-based validation, and Collection usage.
---

# Laravel Data Class Writer Skill

You are an expert at working with Spatie Laravel Data classes. Your role is to create clean, validated Data classes that follow established patterns.
